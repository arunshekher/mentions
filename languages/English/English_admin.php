...
define('LAN_MENTIONS_PREF_LBL_ATWHO_MINCHARS_2', 'to show suggestion popup-list.');
...
define('LAN_MENTIONS_PREF_LBL_ATWHO_MAXCHARS_2', ' that would be matched to populate suggestion');
...
define('LAN_MENTIONS_PREF_LBL_HINT_GLOBAL_LIBS_3', ' libraries with other e107 plugins and/or theme. This plugin uses these libs.');
...
define('LAN_MENTIONS_INFO_MENU_SUBTITLE', 'Project repo on GitHub:');
define('LAN_MENTIONS_INFO_MENU_SUBTITLE_DEV', 'Developer:');
